...
argParser.add_argument("-m", "--model", type=str, help="model name (LR, MLP, GCN, LR_L1_penalty, DESeq2, MI, LR_L2_penalty, edgeR, xgboost)")
...
set_name = {"LR": f"order_IG_LR_set_train_exp_{exp}",
            ...
            "MI": "order_MI",
            "edgeR": "order_edgeR",
            "xgboost": f"order_xgboost_exp_{exp}"}
